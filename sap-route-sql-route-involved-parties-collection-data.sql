CREATE TABLE `sap_route_route_involved_parties_collection_data`
(
    ...
    CONSTRAINT `SAPRouteRouteInvolvedPartiesCollectionData` FOREIGN KEY (`ObjectID`) REFERENCES `sap_route_route_collection_data` (`ObjectID`)
) ENGINE = InnoDB
